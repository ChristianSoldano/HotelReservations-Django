...
function validate() {
  ...
  let checkin = document.getElementById("datePickCheckin");
  let checkout = document.getElementById("datePickCheckout");

  if (checkin != null && checkout != null) {
    if (checkin.value == "") checkin.style.borderColor = "red";
    else validationPoints++;
    if (checkout.value == "") checkout.style.borderColor = "red";
    else validationPoints++;
  }
}
...
function isValid(element, regex) {
  if (element != null) {
    if (regex.exec(element.value) != null) return true;
  }
  return false;
}
